...
If an inference-flavoured reading is still wanted, the closer relative is
the surprise- or free-energy-minimisation literature (Friston, 2010),
where the quantity being minimised is likewise the entropy of an outcome
that is actually observed, rather than of a manufactured optimality
signal. The good regulator theorem can be read as a considerably more
elementary instance of that same idea, one that predates both control as
inference and free-energy accounts by three decades, and inherits none of
the reward-exponentiation baggage because it was never phrased in terms of
...
independently motivated proposals -- efficient coding (Barlow, 1961),
predictive coding, and the information bottleneck (Tishby, Pereira and
Bialek, 1999) -- that arrive at similar demands for compressed,
task-sufficient internal representations from different starting points.
...
\item Friston, K. (2010). The free-energy principle: a unified brain
